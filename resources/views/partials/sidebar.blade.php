<div class="app-container">
    <div class="sidebar">
        ...
        <ul class="sidebar-list">
            <li class="sidebar-list-item @yield('activate-home')">
                <a href="{{ route('home') }}">
            ...
            <li class="sidebar-list-item @yield('activate-huesp')">
                <a href="{{ route('huespedes') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <li class="sidebar-list-item @yield('activate-habit')">
            ...
            <li class="sidebar-list-item @yield('activate-reserv')">
            ...
            <li class="sidebar-list-item @yield('activate-checkin')">
            ...
            <li class="sidebar-list-item @yield('activate-checkout')">
            ...
            <li class="sidebar-list-item @yield('activate-report')">
            ...
            <li class="sidebar-list-item @yield('activate-recep')">
                <a href="{{ route('recepcionistas') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="feather feather-bell">
                        <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
