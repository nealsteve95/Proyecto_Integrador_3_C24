...
@section('button-insert')
    ...
    <a href="{{ route('administrador/createReserva') }}"><button class="app-content-headerButton">Crear
            Reserva</button></a>
@endsection
@if (session('status'))
    <div class="status">
...
<div class="products-area-wrapper tableView">
    ...
    @foreach ($reservas as $reserva)
        @csrf
        <a class="row-element" href="{{ url('administrador/reservas-show', ['id' => $reserva->huesped->_id]) }}">
