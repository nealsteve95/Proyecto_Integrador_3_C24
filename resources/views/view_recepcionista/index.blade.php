...
<li class="sidebar-list-item ">
    <a href="{{ route('administrador/huespedes') }}">
        ...
        <span>Informacion Huespedes</span>
    </a>
</li>
<li class="sidebar-list-item ">
    <a href="{{ route('administrador/habitaciones') }}">
        ...
        <span>Informacion Habitaciones</span>
    </a>
</li>
<li class="sidebar-list-item ">
...
<li class="sidebar-list-item ">
    <a href="{{ route('administrador/checkins') }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" class="feather feather-bell">
            <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
...
<li class="sidebar-list-item ">
    <a href="{{ route('administrador/checkouts') }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" class="feather feather-bell">
            <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" />
